...
-- B[0]	=>  Location: PIN_P2,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
-- B[4]	=>  Location: PIN_N3,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
-- Equation(s):
-- \X~2_combout\ = (\B[3]~input_o\ & (\A[3]~input_o\)) # (!\B[3]~input_o\ & ((\A[4]~input_o\ $ (!\B[4]~input_o\)) # (!\A[3]~input_o\)))
...
-- Equation(s):
-- \X~1_combout\ = (\A[0]~input_o\ & (!\B[1]~input_o\ & (!\B[0]~input_o\ & \A[1]~input_o\)))
...
-- Equation(s):
-- \X~3_combout\ = (\X~1_combout\ & ((\B[2]~input_o\ & (\A[2]~input_o\)) # (!\B[2]~input_o\ & ((\X~2_combout\) # (!\A[2]~input_o\)))))
...
-- Equation(s):
-- \X~0_combout\ = (\A[0]~input_o\ & ((\B[0]~input_o\) # (\B[1]~input_o\ $ (!\A[1]~input_o\)))) # (!\A[0]~input_o\ & (((!\B[0]~input_o\))))

-- pragma translate_off
GENERIC MAP (
	lut_mask => "1010110110100111",
	sum_lutc_input => "datac")
-- pragma translate_on
PORT MAP (
	dataa => \A[0]~input_o\,
...
-- Equation(s):
-- \X~4_combout\ = (\X~3_combout\) # (\X~0_combout\)
...
-- Equation(s):
-- \Y~0_combout\ = (!\B[3]~input_o\ & (\A[3]~input_o\ & (\A[4]~input_o\ & !\B[4]~input_o\)))
...
-- Equation(s):
-- \Y~1_combout\ = (!\B[2]~input_o\ & (\A[2]~input_o\ & (\Y~0_combout\ & \X~1_combout\)))
...
-- Equation(s):
-- \Z~1_combout\ = (\B[3]~input_o\ & (!\A[3]~input_o\)) # (!\B[3]~input_o\ & (\A[3]~input_o\ & (!\A[4]~input_o\ & \B[4]~input_o\)))
...
-- Equation(s):
-- \X~5_combout\ = (!\B[2]~input_o\ & \A[2]~input_o\)
...
-- Equation(s):
-- \Z~0_combout\ = (\A[0]~input_o\ & (\B[1]~input_o\ & (!\B[0]~input_o\ & !\A[1]~input_o\))) # (!\A[0]~input_o\ & (((\B[0]~input_o\))))
...
-- Equation(s):
-- \Z~2_combout\ = (\Z~0_combout\) # ((\Z~1_combout\ & (\X~1_combout\ & \X~5_combout\)))
