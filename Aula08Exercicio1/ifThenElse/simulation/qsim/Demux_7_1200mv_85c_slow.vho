...
SIGNAL \O2$latch~0_combout\ : std_logic;
SIGNAL \O3$latch~combout\ : std_logic;
SIGNAL \O4$latch~combout\ : std_logic;
...
\O2$latch~0\ : cycloneive_lcell_comb
-- Equation(s):
-- \O2$latch~0_combout\ = (\A1~input_o\ & (!\S0~input_o\ & \S1~input_o\))
...
PORT MAP (
	...
	datac => \S0~input_o\,
	datad => \S1~input_o\,
	combout => \O2$latch~0_combout\);

-- Location: LCCOMB_X31_Y72_N28
\O3$latch\ : cycloneive_lcell_comb
-- Equation(s):
-- \O3$latch~combout\ = (\A1~input_o\ & (\S0~input_o\ & !\S1~input_o\))
...
PORT MAP (
	...
	datac => \S0~input_o\,
	datad => \S1~input_o\,
	combout => \O3$latch~combout\);

-- Location: LCCOMB_X31_Y72_N14
\O4$latch\ : cycloneive_lcell_comb
-- Equation(s):
-- \O4$latch~combout\ = (\A1~input_o\ & (\S0~input_o\ & \S1~input_o\))
